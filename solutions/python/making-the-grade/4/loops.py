...
def round_scores(student_scores):
    ...
    return [round(value) for value in student_scores]
...
def above_threshold(student_scores, threshold):
    ...
    """
    return [value for value in student_scores if value >= threshold]
...
def letter_grades(highest):
    ...
    interval = range_size / 4 

    return [ int(41 + interval * num) for num in range(4)]
