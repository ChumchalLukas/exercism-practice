...
def add_me_to_the_queue(express_queue: list[str], normal_queue: list[str], ticket_type: int, person_name: str) -> list[str]:
    ...
    raise ValueError("ticket_type must be 0 (normal) or 1 (express)")
...
def how_many_namefellows(queue: list[str], person_name: str) -> list[str]:
...
def remove_the_last_person(queue: list[str]) -> list[str]:
