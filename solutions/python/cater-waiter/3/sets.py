...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    # deduplication
    ingredients_single = set(dish_ingredients)

    return (dish_name, ingredients_single)
...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    # datatype change:
    drink_ingredients_noduplicates = set(drink_ingredients)

    # possible containing alcohol:
    boozin = drink_ingredients_noduplicates.isdisjoint(ALCOHOLS)
...
def tag_special_ingredients(dish):
    ...
    # ingredients intersection special ingredients:

    ingredients_singles = set(ingredients)
    allergents = ingredients_singles & SPECIAL_INGREDIENTS

    return (dish_name, allergents) 
...
def separate_appetizers(dishes, appetizers):
    ...
    # Rest of dishes:
    rest_menu = dishes_set - appetizers_set

    return list(rest_menu)
